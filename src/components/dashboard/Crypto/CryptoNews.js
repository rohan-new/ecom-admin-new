        ...
        <div className="ant-row-flex gx-justify-content-between gx-mb-3 gx-dash-search">
          ...
          <div className="gx-mx-sm-2">
            <Radio.Group className="gx-radio-group-link gx-radio-group-link-news" defaultValue={0}
              ...
              <Radio.Button value={1} className="gx-mb-1">Sales</Radio.Button>
              <Radio.Button value={2} className="gx-mb-1">Earnings</Radio.Button>
              <Radio.Button value={3} className="gx-mb-1">Revenue</Radio.Button>
            </Radio.Group>
          </div>
