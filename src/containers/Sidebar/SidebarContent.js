            ...
            <Menu
              ...
              <MenuItemGroup key="custom-views" className="gx-menu-group"
                ...
                <SubMenu key="eCommerce" className={this.getNavStyleSubMenuClass(navStyle)}
                  ...
                  <Menu.Item key="custom-views/eCommerce/product-edit">
                    <Link to="/custom-views/eCommerce/product-edit">
                      <IntlMessages
                        id="sidebar.eCommerce.productEdit" /></Link>
                  </Menu.Item>
                  <Menu.Item key="custom-views/eCommerce/orders-list">
                    <Link to="/custom-views/eCommerce/orders-list">
                      <IntlMessages
                        id="sidebar.eCommerce.ordersList" /></Link>
                  </Menu.Item>
                  ...
                  <Menu.Item key="custom-views/eCommerce/payment-details">
                    <Link to="/custom-views/eCommerce/payment-details">
                      <IntlMessages
                        id="sidebar.eCommerce.payment" /></Link>
                  </Menu.Item>
                </SubMenu>
